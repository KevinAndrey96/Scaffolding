...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post tutors_url, params: { tutor: { facultad: @tutor.facultad, nombre: @tutor.nombre, proyecto_id: @tutor.proyecto_id } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { facultad: @tutor.facultad, nombre: @tutor.nombre, proyecto_id: @tutor.proyecto_id } }
