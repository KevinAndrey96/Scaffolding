...
class PatrocinadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create patrocinador" do
    assert_difference('Patrocinador.count') do
      post patrocinadors_url, params: { patrocinador: { nombre: @patrocinador.nombre, telefono: @patrocinador.telefono, tipo: @patrocinador.tipo } }
    end
  ...
  test "should update patrocinador" do
    patch patrocinador_url(@patrocinador), params: { patrocinador: { nombre: @patrocinador.nombre, telefono: @patrocinador.telefono, tipo: @patrocinador.tipo } }
